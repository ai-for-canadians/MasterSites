            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <h1 className="text-5xl md:text-6xl font-bold mb-6 tracking-tight text-slate-50">
                        What your symptoms
                        <span className="text-amber-500"> actually mean</span>
                    </h1>

                    <p className="text-xl text-slate-400 mb-8">
                        Evidence-based guide to understanding symptoms. Know when to worry, when to wait, and when to see someone.
                    </p>
