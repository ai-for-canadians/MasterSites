        ...
        <footer className="bg-slate-900 border-t border-slate-800 py-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-slate-400">
                    <div>
                        <h3 className="text-slate-50 font-semibold mb-4">Debt Freedom</h3>
                        <p className="text-sm leading-relaxed">
                            Helping you get out of debt faster.
                            Mathematically optimal strategies for financial independence.
                        </p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p className="text-sm leading-relaxed mb-4">
                            Not financial advice. We do not offer loans or debt settlement services.
                        </p>
