            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="max-w-3xl mx-auto text-center">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-amber-500/10 border border-amber-500/20 rounded-full text-amber-400 text-sm mb-6">
                        ...
                        <span>Don't wing it. Be prepared.</span>
                    </div>

                    <h1 className="text-5xl md:text-6xl font-bold mb-6 tracking-tight text-slate-50">
                        Scripts for the talks
                        <span className="text-amber-500"> you've been avoiding</span>
                    </h1>

                    <p className="text-xl text-slate-400 mb-8">
                        Frameworks and actionable scripts for hard conversations. Salary negotiations, setting boundaries, finding closure, and more.
                    </p>
                    ...
                    <div className="flex items-center justify-center gap-8 text-sm text-slate-500">
                        ...
                        <div>•</div>
                        <div>Psychologically Safe Frameworks</div>
                    </div>
                </div>
            </div>
        </section>
