                ...
                <div className="mx-auto max-w-2xl text-center">
                    <div className="mb-8 flex justify-center">
                        <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-slate-400 ring-1 ring-white/10 hover:ring-white/20">
                            New: VITAMIN D Review{' '}
                            <Link href="/supplements/vitamin-d" className="font-semibold text-orange-400">
                    ...
                    <h1 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">
                        What actually <span className="text-orange-400">works</span>
                    </h1>

                    <p className="mt-6 text-lg leading-8 text-slate-300">
                        Cut through marketing hype with evidence-based supplement reviews.
                        We analyze clinical data to tell you what's effective, what's a waste of money, and what's dangerous.
                    </p>
