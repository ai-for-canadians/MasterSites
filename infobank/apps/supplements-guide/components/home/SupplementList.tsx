...
export function SupplementList({ title, supplements }: SupplementListProps) {
    return (
                        ...
                        >
                            <div className="p-6">
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <span className={`text-xs font-bold px-2 py-1 rounded-full ${item.evidenceRating === 'A' ? 'bg-green-500/10 text-green-400' :
                                            item.evidenceRating === 'B' ? 'bg-blue-500/10 text-blue-400' :
